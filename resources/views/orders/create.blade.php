<x-layout title='Create Order' heading='Create New Order'>
        ...
        <form action="{{ route('orders.store') }}" method="POST">
            ...
            <div id="order-items">
                <div class="flex space-x-2 mb-2 items-center order-item">
                    <select name="items[0][ProductId]" class="w-1/3 border-2 border-gray-300 rounded product-select">
                    ...
                    <input type="number" name="items[0][Quantity]" value="1"
                        class="w-1/4 border border-gray-300 rounded quantity-input" min="1">
            ...
            <div class="flex justify-end space-x-2 rtl:space-x-reverse">
                ...
                <button type="submit" class="px-4 py-2 bg-indigo-600 rounded text-white hover:bg-indigo-700">Save
                    Order</button>
            </div>
        </form>
    </div>
    ...
    <script>
        ...
        function addRow() {
            ...
            container.innerHTML = `
                ...
                <input type="text" class="w-1/4 border-gray-200 rounded bg-gray-100 text-gray-700 subtotal" readonly placeholder="Subtotal">
