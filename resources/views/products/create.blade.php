<x-layout  title='Add Product' heading='Add New Product'>
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('products.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="number" name="UnitPrice" value="{{ old('UnitPrice') }}"
                    class="mt-1 block w-full rounded border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                    step="1" min="0">
            </div>
            ...
            <div class="flex justify-end space-x-2 rtl:space-x-reverse">
                ...
                <button type="submit"
                    class="px-4 py-2 rounded bg-indigo-600 hover:bg-indigo-700 text-white">Save</button>
            </div>
        </form>
    </div>
</x-layout>
